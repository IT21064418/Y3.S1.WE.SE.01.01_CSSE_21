      ...
      <div className="cusdashcard">
        <a href="#" className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-600 dark:hover:bg-gray-700 cuscardx">
          ...
          <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-300">Total Actions Done - {localStorage.getItem('empTotalServices')}</p>
          </div>
        </a>
        <a href="#" className="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-600 dark:hover:bg-gray-700 cuscardx">
          <div className="color">
            ...
            <div class="cardbutton mt-0.5">
              <a href={`/empdash/empupdate/${localStorage.getItem('empID')}`}>
              ...
              <a href={`/empdash/empdanger/${localStorage.getItem('empID')}`}>
